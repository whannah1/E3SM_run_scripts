...
# NE_DST=30 # don't set here - just supply from command line arg
...
#---------------------------------------------------------------------------
# homme_tool_root=${e3sm_root}/components/homme
...
srun -n 8 ${homme_tool_root}/src/tool/homme_tool < input.nl
