...
GRID_DST=${GRID_ROOT}/${NLAT}x${NLON}_scrip.nc
MAP_FILE=${MAPS_ROOT}/map_ne${NE}pg2_to_${NLAT}x${NLON}_${NCO_ALG}.nc
...
ncremap -G ttl='Equi-Angular grid ${NLAT}x${NLON}'#latlon=${NLAT},${NLON}#lat_typ=uni#lon_typ=grn_wst -g ${GRID_ROOT}/${NLAT}x${NLON}_scrip.nc


time ncremap --alg_typ=${NCO_ALG} --grd_src=${GRID_SRC} --grd_dst=${GRID_DST} --map=${MAP_FILE}
time ncremap --mpi_nbr=8 --alg_typ=${NCO_ALG} --grd_src=${GRID_SRC} --grd_dst=${GRID_DST} --map=${MAP_FILE}


nohup time ncremap--alg_typ=${NCO_ALG} --grd_src=${GRID_SRC} --grd_dst=${GRID_DST} --map=${MAP_FILE} > ncremap.create_map.out &
...
dst_grid = '4000x8000'
map_file = '/lustre/orion/cli115/proj-shared/hannah6/files_map/map_ne1024pg2_to_4000x8000_traave.nc'
...
# case_list.append(f'SCREAM.2025-PC-01.F2010-SCREAMv1-DYAMOND1.ne1024pg2')
# case_list.append(f'SCREAM.2025-PC-01.F2010-SCREAMv1-DYAMOND1.ne1024pg2.cfr_1')
# case_list.append(f'SCREAM.2025-PC-01.F2010-SCREAMv1-DYAMOND1.ne1024pg2.cfr_1.cfi_0.acc_60.rsc_5.eci_0.1.eri_0.1.mti_7.4e6.acp_100.acq_2.5.acn_1.5.acr_2e-05.isf_1')
