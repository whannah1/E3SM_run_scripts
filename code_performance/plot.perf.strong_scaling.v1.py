...
group = []
# group.append(f'E3SM.perf-test.ne30pg2_EC30to60E2r2.WCYCL1850.NTASKS_.NTHRDS_1.00')
# group.append(f'E3SM.perf-test.ne30pg2_EC30to60E2r2.WCYCL1850.NTASKS_.NTHRDS_1.00')
# group.append(f'E3SM.perf-test.ne30pg2_EC30to60E2r2.WCYCL1850.NTASKS_.NTHRDS_1.00')
group.append(f'E3SM.perf-test.ne30pg2_EC30to60E2r2.WCYCL1850.NTASKS_10240.NTHRDS_1.00')
groups.append(group); clr.append('blue'); dsh.append(0)

group = []
# group.append(f'E3SM.perf-test.ne30_oECv3.A_WCYCL1850S_CMIP6.NTASKS_.NTHRDS_1.00')
# group.append(f'E3SM.perf-test.ne30_oECv3.A_WCYCL1850S_CMIP6.NTASKS_.NTHRDS_1.00')
# group.append(f'E3SM.perf-test.ne30_oECv3.A_WCYCL1850S_CMIP6.NTASKS_.NTHRDS_1.00')
group.append(f'E3SM.perf-test.ne30_oECv3.A_WCYCL1850S_CMIP6.NTASKS_5120.NTHRDS_1.00')
...
for case_list in groups:
   for case in case_list:
      ...
      for p in params:
         if p[0]=='NTASKS': node_list_all.append(float(p[1])/64)
...
for param in param_list :
   ...
   for g,data_list in enumerate(group_data_list):
      ...
      for case in case_list:
         params = [p.split('_') for p in case.split('.')]
         for p in params:
            if p[0]=='NN': node_list.append(float(p[1]))
