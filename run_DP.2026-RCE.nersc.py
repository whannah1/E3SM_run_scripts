...
# add_case(prefix='DP.2026-RCE-00', num_nodes=4, ne= 67, lx=600, dt=60, arch='CPU', enable_zm=True, tau=14400 ) # holding off
# add_case(prefix='DP.2026-RCE-00', num_nodes=1, ne= 34, lx=600, dt=60, arch='CPU', enable_zm=True, tau=14400 ) # holding off
