...
acct = 'cli115' # e3sm / m4310 (scidac)
top_dir  = os.getenv('HOME')+'/E3SM/'
# src_dir  = f'{top_dir}/E3SM_SRC2' # master @ June 12
...
# stop_opt,stop_n,resub,walltime = 'ndays',2,0,'1:00:00'
# stop_opt,stop_n,resub,walltime = 'ndays',32,0,'2:00:00'
# stop_opt,stop_n,resub,walltime = 'ndays',16,1,'2:00:00' # 32 days
# stop_opt,stop_n,resub,walltime = 'ndays',16,4-1,'2:00:00' # 64 days
# stop_opt,stop_n,resub,walltime = 'ndays',10,0,'2:00:00'
stop_opt,stop_n,resub,walltime = 'ndays',73,5-1,'2:00:00' # 1-year
# stop_opt,stop_n,resub,walltime = 'ndays',73,5*2-1,'2:00:00' # 1-year
...
# kwargs_L128_v31_alpha3['init_file']  = '/global/cfs/cdirs/e3sm/whannah/files_init/screami_ne256np4L128_ifs-20200120_20220914.L128v3.1_alpha3.nc'
...
# add_case(prefix='2026-vert-test-01', compset='F2010-SCREAMv1', grid='ne256pg2_ne256pg2', num_nodes=64, **kwargs_L128_v31_a10_pm100)
# add_case(prefix='2026-vert-test-01', compset='F2010-SCREAMv1', grid='ne256pg2_ne256pg2', num_nodes=64, **kwargs_L128_v31_a15_pm100)
# add_case(prefix='2026-vert-test-01', compset='F2010-SCREAMv1', grid='ne256pg2_ne256pg2', num_nodes=64, **kwargs_L128_v31_a20_pm100)
# add_case(prefix='2026-vert-test-01', compset='F2010-SCREAMv1', grid='ne256pg2_ne256pg2', num_nodes=64, **kwargs_L128_v31_a25_pm100)
# add_case(prefix='2026-vert-test-01', compset='F2010-SCREAMv1', grid='ne256pg2_ne256pg2', num_nodes=64, **kwargs_L128_v31_a30_pm100)


kwargs_L128_v31_a10_pm100['vgrid_file'] = f'{vert_root}/SCREAM_L128_v3.1_c20251112_alpha_1.0_pm_100.nc'
kwargs_L128_v31_a15_pm100['vgrid_file'] = f'{vert_root}/SCREAM_L128_v3.1_c20251112_alpha_1.5_pm_100.nc'

kwargs_L128_v31_a10_pm100['init_file']  = f'{init_root}/screami_ne30np4L128_20221004.L128v3.1_alpha_1.0_pm_100.nc'
kwargs_L128_v31_a15_pm100['init_file']  = f'{init_root}/screami_ne30np4L128_20221004.L128v3.1_alpha_1.5_pm_100.nc'

add_case(prefix='2026-vert-test-01', compset='F2010-SCREAMv1', grid='ne30pg2_r05_IcoswISC30E3r5', num_nodes=4, **kwargs_L128_v31_a10_pm100)
add_case(prefix='2026-vert-test-01', compset='F2010-SCREAMv1', grid='ne30pg2_r05_IcoswISC30E3r5', num_nodes=4, **kwargs_L128_v31_a15_pm100)
...
IC_SRC=/lustre/orion/cli115/world-shared/e3sm/inputdata/atm/scream/init/screami_ne30np4L128_20221004.nc
IC_DST=/lustre/orion/cli115/proj-shared/hannah6/files_init/screami_ne30np4L128_20221004.L128v3.1_alpha_1.0_pm_100.nc
VG_DST=/lustre/orion/cli115/proj-shared/hannah6/files_vert/SCREAM_L128_v3.1_c20251112_alpha_1.0_pm_100.nc

IC_SRC=/lustre/orion/cli115/world-shared/e3sm/inputdata/atm/scream/init/screami_ne30np4L128_20221004.nc
IC_DST=/lustre/orion/cli115/proj-shared/hannah6/files_init/screami_ne30np4L128_20221004.L128v3.1_alpha_1.5_pm_100.nc
VG_DST=/lustre/orion/cli115/proj-shared/hannah6/files_vert/SCREAM_L128_v3.1_c20251112_alpha_1.5_pm_100.nc
