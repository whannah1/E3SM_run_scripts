...
# add_case(prefix='2026-ZM-DEV-00', compset='F2010xx-ZM', arch='CPU', grid='ne4pg2_oQU480', num_nodes=1, zm='f90', debug=True)
# add_case(prefix='2026-ZM-DEV-00', compset='F2010xx-ZM', arch='CPU', grid='ne4pg2_oQU480', num_nodes=1, zm='cxx', debug=True)

# add_case(prefix='2026-ZM-DEV-00', compset='F2010xx-ZM', arch='GPU', grid='ne4pg2_oQU480', num_nodes=1, zm='f90', debug=True)
# add_case(prefix='2026-ZM-DEV-00', compset='F2010xx-ZM', arch='GPU', grid='ne4pg2_oQU480', num_nodes=1, zm='cxx', debug=True)

# add_case(prefix='2026-ZM-DEV-00', compset='F2010xx-ZM', arch='GPU', grid='ne30pg2_r05_IcoswISC30E3r5', num_nodes=4, zm='f90')
# add_case(prefix='2026-ZM-DEV-00', compset='F2010xx-ZM', arch='GPU', grid='ne30pg2_r05_IcoswISC30E3r5', num_nodes=4, zm='cxx')

# add_case(prefix='2026-ZM-DEV-00', compset='F2010xx-ZM', arch='GPU', grid='ne30pg2_r05_IcoswISC30E3r5', num_nodes=4, zm='f90',zm_detr=False)

# add_case(prefix='2026-ZM-DEV-00', compset='F2010xx-ZM', arch='GPU', grid='ne30pg2_r05_IcoswISC30E3r5', num_nodes=4, zm='f90',zm_detr=True)
# add_case(prefix='2026-ZM-DEV-00', compset='F2010xx-ZM', arch='GPU', grid='ne30pg2_r05_IcoswISC30E3r5', num_nodes=4, zm='cxx',zm_detr=False)
# add_case(prefix='2026-ZM-DEV-00', compset='F2010xx-ZM', arch='GPU', grid='ne30pg2_r05_IcoswISC30E3r5', num_nodes=4, zm='cxx',zm_detr=True)
