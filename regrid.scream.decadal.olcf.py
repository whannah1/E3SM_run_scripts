...
# map_file, dst_grid = '/ccs/home/hannah6/maps/map_ne30pg2_to_90x180_aave.nc', '90x180'
map_file, dst_grid = '/ccs/home/hannah6/maps/map_ne30pg2_to_180x360_traave.20240508.nc', '180x360'
...
for f in file_list_all:
  if '~' in f: continue
  year = int(f[-19:-19+4])
  if year in [1995,1996,1997,1998,1999]:
    file_list.append(f)
