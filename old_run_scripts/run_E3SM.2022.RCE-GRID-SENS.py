...
# compset = 'FRCE-MMF1' ; arch = 'CORI-INTEL'
...
case_list = ['E3SM','RCE-GRID-SENS-00',compset]
...
if 'MMF' in compset:
   if ne==   8: init_file_atm = ''
   if ne==  16: init_file_atm = ''
   if ne==  32: init_file_atm = ''
   if ne==  64: init_file_atm = ''
   if ne== 128: init_file_atm = ''
else:
   if ne==   8: init_file_atm = ''
   if ne==  16: init_file_atm = ''
   if ne==  32: init_file_atm = ''
