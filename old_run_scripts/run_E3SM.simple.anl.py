...
stop_opt,stop_n,resub,walltime = 'nstep',5,0,'0:10:00'

compset,grid = 'F-MMFXX-SCM-ARM97','ne4_ne4'
# compset,grid = 'F-MMFXX','ne4pg2_ne4pg2'

case = '.'.join(['E3SM','rrtmgpxx-test',grid,compset,'ESMT','00'])
