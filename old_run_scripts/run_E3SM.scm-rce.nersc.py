...
src_dir  =  os.getenv('HOME')+'/E3SM/E3SM_SRC0' # whannah/atm/add-scm-rce-compset-v2
...
#-------------------------------------------------------------------------------
compset = 'FSCM-RCE'      ; arch = 'GNUCPU'
# compset = 'FSCM-RCE-MMF1' ; arch = 'GNUGPU'
#-------------------------------------------------------------------------------

case = '.'.join(['E3SM','SCM-TEST-01',arch,compset]) # main runs
# case = '.'.join(['E3SM','SCM-TEST-02',arch,compset]) # test modified shell commands
