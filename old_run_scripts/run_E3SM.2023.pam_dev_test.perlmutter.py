...
# if queue=='regular': stop_opt,stop_n,resub,walltime = 'ndays',32,12-1,'4:00:00'
# if queue=='regular': stop_opt,stop_n,resub,walltime = 'ndays',10,36-1,'4:00:00'
...
# nlev=60;crm_nz=50;case = '.'.join(['E3SM','2023-PAM-DEV-00',arch,grid,compset,f'L{nlev}','TPN_04'])
# nlev=60;crm_nz=50;case = '.'.join(['E3SM','2023-PAM-DEV-00',arch,grid,compset,f'L{nlev}','TPN_32'])

# nlev=60;crm_nz=50;case = '.'.join(['E3SM','2023-PAM-DEV-00',grid,compset,f'L{nlev}'])
...
# nlev=60;crm_nz=50;case = '.'.join(['E3SM','2023-PAM-DEV-01',grid,compset,f'L{nlev}'])
# nlev=64;crm_nz=54;case = '.'.join(['E3SM','2023-PAM-DEV-01',grid,compset,f'L{nlev}']) # disable mixing of qr

# nlev=64;crm_nz=54;case = '.'.join(['E3SM','2023-PAM-DEV-02',arch,grid,compset,f'L{nlev}']); disable_compose=True # test for dycor tracer advection problem
# nlev=64;crm_nz=54;case = '.'.join(['E3SM','2023-PAM-DEV-03',arch,grid,compset,f'L{nlev}']) # test for dycor tracer advection problem - enable SL transport

case = '.'.join(['E3SM','2023-PAM-DEV-02',arch,grid,compset])
