...
if queue=='regular': stop_opt,stop_n,resub,walltime = 'ndays',73,5-1,'2:00:00'
...
case = '.'.join(['E3SM','2024-SOM-rad-00',arch,grid,compset,f'CNXY_{crm_nx}x{crm_ny}',f'RNXY_{rad_nx}x{rad_ny}'])
