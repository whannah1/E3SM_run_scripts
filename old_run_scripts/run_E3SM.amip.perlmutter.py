...
compset,arch,num_nodes = 'F20TR-MMFXX-CMIP6','GNUGPU',128


iyr,imn,idy = 1870,1,1
start_date = f'{iyr}-{imn:02d}-{idy:02d}'

stop_opt,stop_n,resub,walltime = 'ndays',365,31,'4:00:00'
...
case_list = ['E3SM','AMIP',arch,grid,compset]
...
if submit : 
   ...
   if not print_commands_only: 
      ...
      # os.system(f'./xmlchange -file env_run.xml      SSTICE_DATA_FILENAME={atm_init_path}/{init_file_sst}')
