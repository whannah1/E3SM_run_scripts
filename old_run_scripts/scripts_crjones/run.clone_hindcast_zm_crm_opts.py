...
# ===================================================
Config = runsp.Config(newcase=False, config=True, clean=False, build=False,
                      runsim=True, update_namelist=True, debug=False,
                      copyinit=False, testrun=trial_run, hindcast=True,
                      sp=False, continue_run=False)

BuildCase = runsp.Case(case_name="ne30_ZM_spconfig", res="ne30", sp=Config.sp,
...
if Config.build is True:
    ...
    BuildCase.set_cam_config_opts(test=trial_run, default_set=None,
                                  **{'-rad': 'rrtmg',
                                     '-phys': 'cam5',
                                     '-nlev': '72',
                                     '-crm_nz': '58',
