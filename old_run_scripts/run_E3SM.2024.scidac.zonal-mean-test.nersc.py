...
src_dir = os.getenv('HOME')+'/E3SM/E3SM_SRC1' # branch => whannah/atm/add-zonal-mean-mod
...
if queue=='debug'  : stop_opt,stop_n,resub,walltime = 'nsteps',4, 0,'0:30:00'
...
ne,npg,grid = 30,2,f'ne30pg2_oECv3'; num_nodes = 8

# case = '.'.join(['E3SM','2024-SCIDAC-zonal-mean-test-01',arch,grid,compset])
# case = '.'.join(['E3SM','2024-SCIDAC-zonal-mean-test-02',arch,grid,compset]) # new control for fix
case = '.'.join(['E3SM','2024-SCIDAC-zonal-mean-test-03',arch,grid,compset]) # test fix for striping
