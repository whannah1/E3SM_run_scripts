...
compset,ne,npg,grid = 'F2010-MMF1',30,2,'ne30pg2_EC30to60E2r2'

# nlev=60;crm_nz=50;case = '.'.join(['E3SM','2023-SCIDAC-MMF',grid,compset,f'L{nlev}'])
# nlev=64;crm_nz=54;case = '.'.join(['E3SM','2023-SCIDAC-MMF',grid,compset,f'L{nlev}'])
nlev=72;crm_nz=60;case = '.'.join(['E3SM','2023-SCIDAC-MMF',grid,compset,f'L{nlev}'])
