...
fsurdat_root = '/global/cfs/projectdirs/m3312/whannah/HICCUP/files_fsurdat'
grid = f'ne16pg2_oECv3'; fsurdat_path = f'{fsurdat_root}/surfdata_ne16pg2_simyr2010_c240315.nc'
grid = f'ne24pg2_oECv3'; fsurdat_path = f'{fsurdat_root}/surfdata_ne24pg2_simyr2010_c240315.nc'
grid = f'ne70pg2_oECv3'; fsurdat_path = f'{fsurdat_root}/surfdata_ne70pg2_simyr2010_c240315.nc'
...
case = f'ELM_spinup.2024-GB.{compset}.{grid}.{num_years}-yr.{stop_date_str}'
