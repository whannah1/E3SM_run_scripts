...
stop_opt,stop_n,resub,walltime = 'ndays',1,0,'0:20:00'

compset,grid,num_nodes='F2010',       f'ne4pg2_oQU480', 1

case_list = ['E3SM','2024-oro-drag-test-00',grid,compset]
...
if submit : 
   ...
   file.write(f" bnd_topo='$DIN_LOC_ROOT/atm/cam/topo/USGS-gtopo30_ne4np4_16x_forOroDrag.c20241019.nc' \n")
