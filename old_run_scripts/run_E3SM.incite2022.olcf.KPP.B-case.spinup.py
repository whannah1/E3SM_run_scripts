...
stop_opt,stop_n,resub,walltime = 'nstep',12,0,'1:00'
...
dtime = 15*60; ncpl = int( 86400 / dtime )
# dtime = 5*60; ncpl = int( 86400 / dtime )
# dtime = 1*60; ncpl = int( 86400 / dtime )
# dtime = 10; ncpl = int( 86400 / dtime ); crm_dt=2
...
compset,arch,num_nodes,disable_output = 'WCYCL1950',     'GNUCPU', 512, False

#---------------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------------

# specify case name based on configuration
case_list = ['E3SM','2022-KPP-B-SPINUP-00',arch,f'ne{ne}pg{npg}',compset]
...
# if single_thread: case_list.append('SINGLE-THREAD')
...
if build : 
   ...
   # # print()
   # # print(f'ocn_streams_file: {ocn_streams_file}')
   # # print(f'ice_streams_file: {ice_streams_file}')
   # # run_cmd(f'grep "0089" {ocn_streams_file} {ice_streams_file}  -A15 -B15')
   # # run_cmd(f'grep "0089" {ice_streams_file}  -A15 -B15')
   # # print()
   # # exit('EXITING - check for SourceMods edits!')
