...
stop_opt,stop_n,resub,walltime = 'ndays',73,4,'6:00'
...
# docoriolis=False; case_list=['E3SM','2023-coriolis-test',arch,grid,compset,'coriolis-off']
# docoriolis=True ; case_list=['E3SM','2023-coriolis-test',arch,grid,compset,'coriolis-on']

# nx,ny=32,1;docoriolis=False; case_list=['E3SM','2023-coriolis-test',arch,grid,compset,f'NXY_{nx}_{ny}','coriolis-off']
nx,ny=32,1;docoriolis=True ; case_list=['E3SM','2023-coriolis-test',arch,grid,compset,f'NXY_{nx}_{ny}','coriolis-on']

# nx,ny=32,32;docoriolis=False; case_list=['E3SM','2023-coriolis-test',arch,grid,compset,f'NXY_{nx}_{ny}','coriolis-off']
# nx,ny=32,32;docoriolis=True ; case_list=['E3SM','2023-coriolis-test',arch,grid,compset,f'NXY_{nx}_{ny}','coriolis-on']
