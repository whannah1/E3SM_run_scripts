#!/usr/bin/env python3
#---------------------------------------------------------------------------------------------------
# command to recreate initial condition:
# ncremap -m ~/maps/RRM/map_ne45np4_to_RRM-cubeface-grad-ne30x3np4_mono_20210901.nc -i /global/cfs/cdirs/e3sm/inputdata/atm/cam/inic/homme/eam_i_aquaplanet_ne45np4_L60_c20210823.nc -o /pscratch/sd/w/whannah/e3sm_scratch/init_scratch/eam_i_aqua_RRM-cubeface-grad-ne30x3_L60_c20220225.nc
#---------------------------------------------------------------------------------------------------
...
src_dir  = os.getenv('HOME')+'/E3SM/E3SM_SRC2/' # whannah/mmf/test-scaled-dx
...
ne,npg,rad_nx    = 0,2,4
use_vt,use_momfb = True,False
# nlev,crm_nz      = 60,50



# crm_nx,crm_ny = 64,1; num_nodes,stop_opt,stop_n,resub,walltime,queue = 128,'nday',1,0,'2:00:00','regular' 
# crm_nx,crm_ny = 64,1; num_nodes,stop_opt,stop_n,resub,walltime,queue = 128,'nday',5,11+2,'4:00:00','regular'
crm_nx,crm_ny = 64,1; num_nodes,stop_opt,stop_n,resub,walltime,queue = 128,'nstep',10,0,'0:30:00','debug'
...
compset = 'F-MMFXX-AQP1' ; arch = 'GNGPU'
# compset = 'F-EAM-AQP1' ; arch = 'GNCPU'
...
# case_list = ['E3SM','AQUA-RRM-TEST',compset]
case_list = ['E3SM','AQUA-RRM-TEST',compset,grid_name,f'GCMDT_{gcm_dt_min}']
...
# hiccup_scratch = '/global/cscratch1/sd/whannah/HICCUP/data' # cori
hiccup_scratch = '/pscratch/sd/w/whannah/e3sm_scratch/init_scratch' # perlmutter
# if grid=='ne0_cubeface_grad_ne30x3pg2': init_file_atm = f'{hiccup_scratch}/eam_i_aqua_RRM-cubeface-grad-ne30x3_L60_c20210907.nc'
if grid=='ne0_cubeface_grad_ne30x3pg2': init_file_atm = f'{hiccup_scratch}/eam_i_aqua_RRM-cubeface-grad-ne30x3_L60_c20220225.nc'
# if grid=='ne0_cubeface_grad_ne4x6pg2' : init_file_atm = f'{hiccup_scratch}/eam_i_aqua_RRM-cubeface-grad-ne4x6_L60_c20210907.nc'
# if grid=='ne0_cubeface_grad_ne4x5pg2' : init_file_atm = f'{hiccup_scratch}/eam_i_aqua_RRM-cubeface-grad-ne4x5_L60_c20210907.nc'
...
if 'AQUA-RRM-TEST' in case: dtime = gcm_dt_min*60
