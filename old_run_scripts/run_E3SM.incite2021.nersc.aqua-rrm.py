...
# crm_nx,crm_ny = 32,1; num_nodes,stop_opt,stop_n,resub,walltime,queue = 128,'nday',1,4,'2:00:00','regular' 
crm_nx,crm_ny = 32,1; num_nodes,stop_opt,stop_n,resub,walltime,queue = 128,'nday',5,11+2,'4:00:00','regular'
# crm_nx,crm_ny = 32,1; num_nodes,stop_opt,stop_n,resub,walltime,queue = 20,'nstep',10,0,'0:30:00','debug'
...
if newcase :
   ...
   cmd = cmd + f' -pecount {atm_ntasks}x1 '
