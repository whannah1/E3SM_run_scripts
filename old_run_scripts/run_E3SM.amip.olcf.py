...
# compset,arch,num_nodes,crm_nx,crm_ny,use_momfb,use_vt = 'F20TRC5-CMIP6',    'GNUCPU',  64, 0, 0,False,False
compset,arch,num_nodes,crm_nx,crm_ny,use_momfb,use_vt = 'F20TR-MMFXX-CMIP6','GNUGPU', 113,32, 1,True,True
# compset,arch,num_nodes,crm_nx,crm_ny,use_momfb,use_vt = 'F20TR-MMFXX-CMIP6','GNUCPU', 113,64, 1,True,True


iyr,imn,idy = 2010,1,1
# iyr,imn,idy = 1998,1,1
start_date = f'{iyr}-{imn:02d}-{idy:02d}'

# stop_opt,stop_n,resub,walltime = 'ndays',1,0,'0:10'
stop_opt,stop_n,resub,walltime = 'nstep',10,0,'0:20'
...
case_list = ['E3SM','TEST-AMIP',arch,grid,compset,start_date]
...
if submit : 
   ...
   if not print_commands_only: 
      ...
      file.write(             ",'OMEGA850','OMEGA500','T500','T850','Q850','U200','U850','V200','V850'")
      ...
      #-------------------------------------------------------
      # Special stuff for AMIP mode
      #-------------------------------------------------------
      os.system(f'./xmlchange -file env_run.xml      RUN_STARTDATE={start_date}')
