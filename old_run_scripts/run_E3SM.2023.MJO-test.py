...
src_dir  = top_dir+'/E3SM_SRC0' # whannah/mmf/coriolis-test
...
stop_opt,stop_n,resub,walltime = 'ndays',365,10,'6:00'


### set grid
ne=30; grid=f'ne30pg2_EC30to60E2r2';  num_nodes=64


# nx,rx,dx= 32,4,4000;case_list=['E3SM','2023-MJO-test',arch,grid,compset,f'NX_{nx}',f'RX_{rx}',f'DX_{dx}']
# nx,rx,dx= 64,4,2000;case_list=['E3SM','2023-MJO-test',arch,grid,compset,f'NX_{nx}',f'RX_{rx}',f'DX_{dx}']
# nx,rx,dx=128,4,1000;case_list=['E3SM','2023-MJO-test',arch,grid,compset,f'NX_{nx}',f'RX_{rx}',f'DX_{dx}']


# nlev,crm_nz=60,50; nx,rx,dx= 32,4,4000;case_list=['E3SM','2023-MJO-test',arch,grid,compset,f'L{nlev}',f'NX_{nx}',f'RX_{rx}',f'DX_{dx}']
# nlev,crm_nz=60,50; nx,rx,dx= 64,4,2000;case_list=['E3SM','2023-MJO-test',arch,grid,compset,f'L{nlev}',f'NX_{nx}',f'RX_{rx}',f'DX_{dx}']
# nlev,crm_nz=60,50; nx,rx,dx=128,4,1000;case_list=['E3SM','2023-MJO-test',arch,grid,compset,f'L{nlev}',f'NX_{nx}',f'RX_{rx}',f'DX_{dx}']

# nlev,crm_nz=72,60; nx,rx,dx= 32,4,4000;case_list=['E3SM','2023-MJO-test',arch,grid,compset,f'L{nlev}',f'NX_{nx}',f'RX_{rx}',f'DX_{dx}']
nlev,crm_nz=72,60; nx,rx,dx= 64,4,2000;case_list=['E3SM','2023-MJO-test',arch,grid,compset,f'L{nlev}',f'NX_{nx}',f'RX_{rx}',f'DX_{dx}']
# nlev,crm_nz=72,60; nx,rx,dx=128,4,1000;case_list=['E3SM','2023-MJO-test',arch,grid,compset,f'L{nlev}',f'NX_{nx}',f'RX_{rx}',f'DX_{dx}']
...
init_scratch = '/gpfs/alpine/scratch/hannah6/cli115/HICCUP/data'
...
if config :
   ...
   run_cmd(f'./xmlchange --append --id CAM_CONFIG_OPTS --val \" -crm_nx {nx} -crm_dx {dx} -crm_nx_rad {rx} \" ')
   #-------------------------------------------------------
   cpp_opt = ''
   # if docoriolis: cpp_opt += f' -DMMF_DO_CORIOLIS'
   if cpp_opt != '' :
