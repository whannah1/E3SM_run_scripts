...
set job_name       = F20TR_tauk5x_2400
set compset        = F20TRC5AV1C-04P2
...
set acme_tag       = master
set tag_name       = 20170731
# set tag_name       = 20170830
# set tag_name       = ''

### CUSTOM CASE_NAME (NEEDS TO BE HERE SINCE USED FOR DIRECTORIES BELOW)
set case_name = ${tag_name}.${job_name}.${resolution}.${machine}
# set case_name = ${job_name}.${resolution}.${machine}

### BUILD OPTIONS
set debug_compile  = false
set old_executable = true #/global/cscratch1/sd/golaz/ACME_simulations/20170731.F20TR_ck10.ne30_ne30.edison/build/acme.exe
...
### DIRECTORIES
set code_root_dir               = /global/homes/w/whannah/ACME/ACME_SRC_tag
...
# cp  /global/homes/w/whannah/ACME/ACME_SRC/components/cam/src/physics/cam/zm_conv.F90   $case_scripts_dir/SourceMods/src.cam/
...
#this is a 114 node layout for F-compsets on Edison using hyperthreading. It gets 9.6 SYPD
else if ( `lowercase $processor_config` == 'custom114' ) then

  $xmlchange_exe -file env_mach_pes.xml MAX_TASKS_PER_NODE="48"
  $xmlchange_exe -file env_mach_pes.xml PES_PER_NODE="24"

  $xmlchange_exe --id NTASKS_ATM --val 1350
  $xmlchange_exe --id NTHRDS_ATM --val 4
  $xmlchange_exe --id ROOTPE_ATM --val 0

  $xmlchange_exe --id NTASKS_LND --val 984
  $xmlchange_exe --id NTHRDS_LND --val 4
  $xmlchange_exe --id ROOTPE_LND --val 384

  $xmlchange_exe --id NTASKS_ICE --val 384
  $xmlchange_exe --id NTHRDS_ICE --val 1
  $xmlchange_exe --id ROOTPE_ICE --val 0

  $xmlchange_exe --id NTASKS_OCN --val 256
  $xmlchange_exe --id NTHRDS_OCN --val 1
  $xmlchange_exe --id ROOTPE_OCN --val 0

  $xmlchange_exe --id NTASKS_CPL --val 984
  $xmlchange_exe --id NTHRDS_CPL --val 4
  $xmlchange_exe --id ROOTPE_CPL --val 384

  $xmlchange_exe --id NTASKS_GLC --val 1
  $xmlchange_exe --id NTHRDS_GLC --val 1
  $xmlchange_exe --id ROOTPE_GLC --val 384

  $xmlchange_exe --id NTASKS_ROF --val 984
  $xmlchange_exe --id NTHRDS_ROF --val 4
  $xmlchange_exe --id ROOTPE_ROF --val 384

  $xmlchange_exe --id NTASKS_WAV --val 384
  $xmlchange_exe --id NTHRDS_WAV --val 4
...
# Adapted from edison 114 node layout
else if ( `lowercase $processor_config` == 'custom-corihaswell86' ) then

  $xmlchange_exe -file env_mach_pes.xml MAX_TASKS_PER_NODE="64"
  $xmlchange_exe -file env_mach_pes.xml PES_PER_NODE="32"

  $xmlchange_exe --id NTASKS_ATM --val 1350
  $xmlchange_exe --id NTHRDS_ATM --val 4
  $xmlchange_exe --id ROOTPE_ATM --val 0

  $xmlchange_exe --id NTASKS_LND --val 992
  $xmlchange_exe --id NTHRDS_LND --val 4
  $xmlchange_exe --id ROOTPE_LND --val 384
  ...
  $xmlchange_exe --id NTASKS_CPL --val 992
  $xmlchange_exe --id NTHRDS_CPL --val 4
  $xmlchange_exe --id ROOTPE_CPL --val 384
  ...
  $xmlchange_exe --id NTASKS_ROF --val 992
  $xmlchange_exe --id NTHRDS_ROF --val 4
  $xmlchange_exe --id ROOTPE_ROF --val 384
...
$xmlchange_exe --id CAM_CONFIG_OPTS --append --val " -cppdefs ' -DZM_TAU_MOD ' "
...
cat <<EOF >> user_nl_cam
 nhtfrq = 0,-24,-6,-3,-24
 mfilt  = 1,30,120,240,30
 cosp_lite = .true.
 fexcl1 = 'CFAD_SR532_CAL'
 fincl2 = 'PRECC','PRECL','U200','U850','V200','V850','OMEGA500','FLUT','Z500','PS','PSL','LHFLX','SHFLX','TMQ','TS','SST'
 fincl3 = 'PSL','T200','T500','U850','V850','UBOT','VBOT'
 fincl4 = 'PRECT','PRECC'
 fincl5 = 'OMEGA500:A','SST:A','TS','TSMN','TSMX','TREFHT:A','TREFHTMN:M','TREFHTMX:X','U250:A','U850:A','UBOT:A','V250:A','V850:A','VBOT:A','T200:A','T300:A','T500:A','T850:A','Z200:A','Z300:A','Z500:A','Z1000:A','ZBOT:A','TMQ:A','PS:A','PSL:A','PRECC:A','PRECL:A','PRECT:A','U010:A','Z050:A','U200:A','V200:A','PREC_PCW:A','PREC_zmc:A','TMQ:A','TREFHTMN:A','TREFHTMX:A','DIV:A'
 avgflag_pertape(2) = 'A'
 avgflag_pertape(3) = 'I'
 avgflag_pertape(4) = 'A'
 zmconv_tau = 2400
