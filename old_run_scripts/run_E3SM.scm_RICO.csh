...
#######  BEGIN USER DEFINED SETTINGS
  ...
  # setenv casename e3sm_scm_RICO_rrtmgp
  setenv casename E3SM.SCM-TEST.F-SCM-RICO.00
  ...
  setenv casedirectory $HOME/E3SM/Cases

  # Directory where code lives
  setenv code_dir $HOME/E3SM/E3SM_BASE

  # Code tag name
  # setenv code_tag '20210715'
...
# End Case specific stuff here
  ...
  set run_root_dir = $HOME/E3SM/scratch/$CASEID
...
# Create new case
  ...
  # ./create_newcase -case $casename --script-root $casedirectory -mach $machine -project $PROJECT -compset $compset -res $grid
...
# CAM configure options.  By default set up with settings the same as E3SMv1
  set CAM_CONFIG_OPTS="-phys ${physset} -scam -nlev 72 -clubb_sgs -rad rrtmgp"
  if ($dycore == Eulerian) then
