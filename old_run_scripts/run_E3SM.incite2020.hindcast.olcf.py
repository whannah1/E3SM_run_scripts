...
case_list = ['INCITE2020','HC',arch,grid,compset,f'NXY_{crm_nx}x{crm_ny}']

### specific case names and settings


# walltime='4:00' ;case='.'.join(case_list+['DX_1600','L_50_47'  ,'DT_5e0',init_date] )
...
# walltime='10:00';case='.'.join(case_list+['DX_200','L_50_47'  ,'DT_5e-1',init_date] )
...
### cases with bulk variance transport
# walltime='2:00' ;case='.'.join(case_list+['DX_1600','L_50_47'  ,'DT_5e0' ,'BVT',init_date] )
...
# walltime='6:00' ;case='.'.join(case_list+['DX_200' ,'L_50_47'  ,'DT_5e-1','BVT',init_date] )
# walltime='6:00' ;case='.'.join(case_list+['DX_200' ,'L_125_115','DT_5e-1','BVT',init_date] )
walltime='6:00' ;case='.'.join(case_list+['DX_200' ,'L_250_230','DT_5e-1','BVT',init_date] )
...
for p in params:
   if p[0]=='L': init_file_atm = f'HICCUP.atm_era5.{init_date}.ne{ne}np4.L{p[1]}.nc'
...
if submit : 
   ...
   if 'L_250' in case: file.write(' se_tstep = 120 \n')
