...
set acme_tag       = master
set tag_name       = master_2017-02-01
...
# These were chosen based on the smallest pe layouts of provided input files
  $xmlchange_exe --id NTASKS_ATM --val 1800
  $xmlchange_exe --id NTASKS_LND --val 1800
  $xmlchange_exe --id NTASKS_ICE --val 1800
  $xmlchange_exe --id NTASKS_OCN --val 1800
  $xmlchange_exe --id NTASKS_CPL --val 1800
  $xmlchange_exe --id NTASKS_GLC --val 1
  $xmlchange_exe --id NTASKS_ROF --val 1
  $xmlchange_exe --id NTASKS_WAV --val 1800
