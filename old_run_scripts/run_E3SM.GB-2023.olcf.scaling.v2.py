...
num_nodes = 32 # 48 / 24 / 12 / 8 / 6 / 4 / 3 / 2 / 1

# case_list = ['E3SM','GB2023-TIMING-01',arch,f'ne{ne}pg{npg}',compset,'dyn_npes_fixed']
# case_list = ['E3SM','GB2023-TIMING-01',arch,f'ne{ne}pg{npg}',compset,'dyn_npes_fixed_16']
case_list = ['E3SM','GB2023-TIMING-01',arch,f'ne{ne}pg{npg}',compset,'dyn_npes_unset']
...
if 'dyn_npes_fixed' in case:
   dyn_npes = None
   if ne==4: dyn_npes = max_mpi_per_node
   # if 'dyn_npes_fixed_16' in case: dyn_npes = 16
   if dyn_npes is None: exit('ERROR: something went wrong...?')
