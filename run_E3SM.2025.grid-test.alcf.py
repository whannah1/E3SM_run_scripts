...
# src_dir=f'{top_dir}/E3SM_SRC0'; add_case(prefix='2025-grid-test-00', arch='GPU', num_nodes=4,  compset='F2010-SCREAMv1', grid='ne32pg2_r025_RRSwISC6to18E3r5', debug=True )
# src_dir=f'{top_dir}/E3SM_SRC0'; add_case(prefix='2025-grid-test-00', arch='GPU', num_nodes=4, compset='F2010-SCREAMv1-MPASSI', grid='ne32pg2_r025_RRSwISC6to18E3r5', debug=True )

# src_dir=f'{top_dir}/E3SM_SRC0'; add_case(prefix='2025-grid-test-00', arch='GPU', num_nodes=4,  compset='F2010-SCREAMv1', grid='ne32pg2_r025_RRSwISC6to18E3r5' )
# src_dir=f'{top_dir}/E3SM_SRC0'; add_case(prefix='2025-grid-test-00', arch='GPU', num_nodes=16, compset='F2010-SCREAMv1', grid='ne64pg2_r025_RRSwISC6to18E3r5' )
# src_dir=f'{top_dir}/E3SM_SRC0'; add_case(prefix='2025-grid-test-00', arch='GPU', num_nodes=32, compset='F2010-SCREAMv1', grid='ne128pg2_r025_RRSwISC6to18E3r5' )

# src_dir=f'{top_dir}/E3SM_SRC0'; add_case(prefix='2025-grid-test-00', arch='GPU', num_nodes=4, compset='F2010-SCREAMv1-MPASSI', grid='ne32pg2_r025_RRSwISC6to18E3r5' )
# src_dir=f'{top_dir}/E3SM_SRC0'; add_case(prefix='2025-grid-test-00', arch='GPU', num_nodes=4, compset='F2010-SCREAMv1-MPASSI', grid='ne64pg2_r025_RRSwISC6to18E3r5' )
# src_dir=f'{top_dir}/E3SM_SRC0'; add_case(prefix='2025-grid-test-00', arch='GPU', num_nodes=16, compset='F2010-SCREAMv1-MPASSI', grid='ne128pg2_r025_RRSwISC6to18E3r5' )
...
# add_case(prefix='2025-grid-test-00', arch='GPU', num_nodes=4,  compset='F2010-SCREAMv1', grid='ne32pg2_ne32pg2' )
# add_case(prefix='2025-grid-test-00', arch='GPU', num_nodes=16, compset='F2010-SCREAMv1', grid='ne64pg2_ne64pg2' )
# add_case(prefix='2025-grid-test-00', arch='GPU', num_nodes=32, compset='F2010-SCREAMv1', grid='ne128pg2_ne128pg2' )

# add_case(prefix='2025-grid-test-00', arch='GPU', num_nodes=4,  compset='F2010-SCREAMv1', grid='ne32pg2_ne32pg2', debug=True )
...
def main(opts):
   ...
   if config : 
      ...
      #-------------------------------------------------------------------------
      # if num_nodes== 1: run_cmd(f'./xmlchange NTASKS_OCN=8,NTASKS_ICE=8 ')
      # if num_nodes== 4: run_cmd(f'./xmlchange NTASKS_OCN=8,NTASKS_ICE=8 ')
      # if num_nodes==16: run_cmd(f'./xmlchange NTASKS_OCN=8,NTASKS_ICE=8 ')
      #-------------------------------------------------------------------------
