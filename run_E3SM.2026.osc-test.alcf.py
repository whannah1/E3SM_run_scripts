...
# add_case(prefix='2026-osc-test-00', arch='GPU', compset='F2010-SCREAMv1', grid='ne256', num_nodes=256 ) # dt_phys=10-min

# add_case(prefix='2026-osc-test-00', arch='GPU', compset='F2010-SCREAMv1', grid='ne256', num_nodes=256, NCPL=120 ) # dt_phys=12-min
# add_case(prefix='2026-osc-test-00', arch='GPU', compset='F2010-SCREAMv1', grid='ne256', num_nodes=256, NCPL=144 ) # dt_phys=10-min
# add_case(prefix='2026-osc-test-00', arch='GPU', compset='F2010-SCREAMv1', grid='ne256', num_nodes=256, NCPL=240 ) # dt_phys= 6-min
add_case(prefix='2026-osc-test-00', arch='GPU', compset='F2010-SCREAMv1', grid='ne256', num_nodes=256, NCPL=288 ) # dt_phys= 5-min
...
field_txt_2D = '''
      ...
      - surf_mom_flux
      - T_2m_atm_backtend
      - wind_speed_10m_atm_backtend
      - surf_sens_flux_atm_backtend
'''
