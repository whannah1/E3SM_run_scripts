...
prefix = '2025-EACB-v1' # alt time step settings - see set_timestep section

src_dir = '/global/homes/w/whannah/E3SM/E3SM_SRC2' # branch => whannah/2025-eamxx-autocal-blitz
...
def run_ens_member(opts):
   ...
   if set_timestep:
      ...
      #------------------------------------------------------------------------------------------------
      # use resolution specific time step settings for (same as 2025-EACB-v4 cases at ALCF)
