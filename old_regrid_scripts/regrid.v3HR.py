...
# case_list.append('E3SM.2025-v3HR-QBO-03.ne120pg2.NN_75.effgw_cm_1.0.frontgfc_1.25D-15')

src_root = '/global/cfs/cdirs/e3sm/ndk/tmpdata/'
dst_root = '/pscratch/sd/w/whannah/e3sm_scratch/pm-cpu'
src_sub_dir = 'run'
dst_sub_dir = f'remap_{dst_grid}'

case_list.append('20250612.v3HR.QBO-ndk.F20TR.fgfc_2E-14.tsps_1.c17-jun4.alvarez-cpu')
# case_list.append('20250612.v3HR.QBO-ndk.F20TR.fgfc_2E-14.tsps_2.c17-jun4.alvarez-cpu')
