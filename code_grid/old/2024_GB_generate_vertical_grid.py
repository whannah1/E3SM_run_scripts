...
def main():
    ...
    ### L256 + 20 (so we can use 256 in CRM and have higher top for GCM)
    # dk_list = [100,20,20, 50, 50, 16, 20]
    # dz_list = [ 50,60,80,100,200,400,800]

    ### L256 + 20 (so we can use 256 in CRM and have higher top for GCM) - smoother version
    # dk_list = [100,20,20,20, 20, 20, 20, 20, 16, 20]
    # dz_list = [ 50,55,65,80,100,140,200,300,400,800]

    ### L256 + 20 - prioritize finer resolution at lower levels
    # grid_name = 'L276_GB2024'
    # dk_list = [100,120, 56]
    # dz_list = [ 20,120,250]

    ### L128 + 20 - compromize for memory management
    grid_name = 'L148_GB2024'
    dk_list = [60, 68, 20]
    dz_list = [40,200,500]
