...
def main():
    ...
    #---------------------------------------------------------------------------
    ### L120
    # dk_list = [ 5,10,20, 8,12, 10, 10, 12, 20,  6,  3,  4]
    # dz_list = [50,30,20,30,50,100,200,250,500,1e3,2e3,5e3]

    ### L100
    # dk_list = [30, 15, 10, 12, 20,  6,  3,  4]
    # dz_list = [50,100,200,250,500,1e3,2e3,5e3]

    ### L50 - v2 uses smoothing
    # grid_name = 'L50_v2'
    # dk_list = [ 15,  6,  5,  6,  10,  3,  2,  3]
    # dz_list = [100,200,400,500,1000,2e3,4e3,6e3]

    ### L55 - Add more levels to top of L50_v2
    # grid_name = 'L55_v2'
    # dk_list = [ 15,  6,  5,  6,  10,  3,  5,  5]
    # dz_list = [100,200,400,500,1000,2e3,4e3,5e3]

    ### L60 - Another go at the idea behind L50
    # grid_name = 'L60'
    # dk_list = [ 12,  8,  8,  8,   8,  8,  8]
    # dz_list = [100,200,400,500,1000,2e3,4e3]

    ### L100 (L60++) - for QBO test
    # grid_name = 'L100'
    # dk_list = [ 12,  8,  8,  8, 16, 32, 16]
    # dz_list = [100,200,400,500,500,500,2e3]

    ### L72 alt (based on L60) - for QBO test
    # grid_name = 'L72_alt'
    # dk_list = [  8,  6,  6, 30,  11,   11]
    # dz_list = [100,200,400,550,1200,2.5e3]
    # nsmooth = 40

    ### L72 - attempt to recreate E3SM grid
    # grid_name = 'L72_E3SM_alt'
    ...
    # nsmooth = 20
    # if sum(dk_list)<72:
    #     dk_list.append(72-sum(dk_list))
    #     # dz_list.append(np.max(np.array(dz_list)))
    #     dz_list.append(0)
    #     print('WARNING: appending zero thickness values!')
