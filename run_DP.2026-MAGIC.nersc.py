...
queue,stop_opt,stop_n,resub,walltime = 'regular','nhours',78,0,'1:00:00'
...
def main(opts):
   ...
   if config : 
      ...
      run_cmd(f'./atmchange -b iop_file={din_loc_root}/atm/cam/scam/iop/MAGIC_iopfile_4scam.nc')
   ...
   if submit : 
      #-------------------------------------------------------------------------
      sst_file = f'{din_loc_root}/ocn/docn7/SSTDATA/SCM_MAGIC_15A_sst_v0.3_2013-07-20-13UTC.nc'
      run_cmd(f'./xmlchange SSTICE_DATA_FILENAME="{sst_file}"')
      run_cmd('./xmlchange SSTICE_YEAR_ALIGN=2013')
      run_cmd('./xmlchange SSTICE_YEAR_START=2013')
      run_cmd('./xmlchange SSTICE_YEAR_END=2014')
      #-------------------------------------------------------------------------
      hist_file_list = []
